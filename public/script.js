...
const translations = {
    ...
    en: {
        ...
        upload_formats: "Max 15MB (JPG, PNG, WEBP, BMP)", // Corrected formats listed
        ...
        preset_photo: "Photograph", // Used in HTML example card title
        preset_clipart: "Clipart / Logo", // Used in HTML example card title
        preset_pixel: "Pixel Art", // Used in HTML example card title
        preset_original: "Original", // Used in HTML example image label
        preset_vectorized: "Vectorized", // Used in HTML example image label
        // Landing Page - CTA
        ...
        spline_threshold_label: "Spline Threshold:",
        ...
        preview_placeholder_select: "SVG result will appear here", // Used in HTML
        ...
        faq_a_upload_failed: "Check for image compatibility. Vectorise.Me only handles JPG, PNG, WEBP and BMP. If you have images of different formats, convert them first before uploading them.",
