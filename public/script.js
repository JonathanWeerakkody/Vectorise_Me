...
const translations = {
    ...
    en: {
        ...
        meta_description_main: "Free online tool to convert raster images (JPG, PNG, WEBP, BMP) to scalable vector graphics (SVG) with real-time customization and presets.",
        ...
        landing_h1_main_seo: "Free & Customizable Online Image to SVG Converter", // SEO H1
        landing_h1_free: "Only FREE", // Fallback H1 parts if needed
        landing_h1_and: "and",
        landing_h1_customizable: "CUSTOMIZABLE Vectorizer",
        landing_subheadline_detailed_seo: "Instantly convert JPG, PNG, and BMP images into high-quality, scalable vector graphics (SVG) online for free. SVGs are perfect for web use, logos, and illustrations because they scale infinitely without losing quality. Our tool uses advanced tracing options and helpful presets for precise results, giving you full control over the conversion process.", // SEO Description
        landing_subheadline_detailed: "Instantly convert raster images (JPG, PNG, BMP) into crisp, infinitely scalable SVG vectors online for free. Features advanced tracing options with helpful presets for precise results.", // Fallback
        ...
        // Info Tooltip Texts
        info_preset: "Select a preset based on your image type for recommended starting settings.",
        info_color_detail: "Controls the number of colors used in the output SVG. Higher bit values mean more colors (closer to original, larger file). Lower values posterize the image (fewer colors, smaller file).",
        info_color_mode: "'Color' preserves multiple colors (use with Color Detail). 'Binary' creates a pure black and white output based on a brightness threshold.",
        info_filter_speckle: "Removes small spots or 'speckles' smaller than this size (in pixels). Higher values remove larger spots but can erase fine details. Set to 0 to disable. Max value is 16.",
        info_mode: "'Spline' creates smooth curves (good for photos, illustrations). 'Polygon' creates shapes with straight lines/sharp corners (good for technical drawings, some logos). 'Pixel' creates exact squares for pixel art.",
        info_corner_threshold: "Controls how sharp corners need to be before they are considered corners (vs. smooth curves). Higher values create more smooth curves. Lower values create more sharp corners. Measured in degrees.",
        info_path_precision: "Number of decimal places used for coordinates in the SVG path data. Higher values are more precise but increase file size. Lower values simplify paths and reduce size.",
        info_spline_threshold: "(Spline Mode Only) Controls how closely the generated splines follow the original image contours. Lower values follow more closely (more detail, potentially more complex). Higher values simplify curves.",
        info_splice_threshold: "(Spline Mode Only) Controls merging of nearly collinear path segments. Higher values simplify by merging more aggressively. Measured in degrees.",
        info_segment_length: "(Spline Mode Only) Controls the maximum length allowed for curve segments. Lower values create more segments (more detail). Higher values simplify curves.",
        info_layering: "(Color Mode Only) 'Stacked' layers colors on top of each other (preserves shapes well). 'Cutout' cuts shapes from the layers below (can reduce overlaps, might alter appearance).",
        info_gradient_step: "(Color Mode Only) Simplifies gradients by reducing the number of color steps. Higher values result in more posterized gradients. Set to 0 or 1 for smooth gradients. Must be a whole number.",
        // Common App View
        ...
        privacy_disclosure_actual: "We may disclose your Usage Data under limited circumstances, such as to comply with legal obligations, protect our rights or the rights of others, prevent wrongdoing, or in the event of a business transfer (e.g., merger or acquisition).",
